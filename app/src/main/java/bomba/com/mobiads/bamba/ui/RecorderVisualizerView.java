...
/**
 * Created by Thinkpad on 09/24/17.
 */
...
public class RecorderVisualizerView extends View {
    ...
    private static final int SPACING = 2; // spacing between visualizer lines
    ...
    public RecorderVisualizerView(Context context, AttributeSet attrs) {
        ...
        linePaint.setColor(Color.rgb(85, 85, 85)); // set color to green
    ...
    public void addAmplitude(float amplitude) {
        ...
        if (amplitudes.size() * (LINE_WIDTH + SPACING) >= width) {
    ...
    public void onDraw(Canvas canvas) {
        ...
        for (float power : amplitudes) {
            ...
            curX += LINE_WIDTH + SPACING; // increase X by LINE_WIDTH
